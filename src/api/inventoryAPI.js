...
// List (frontend expects /inventory -> { items, consumables })
// Added optional roomId param for dynamic room filtering
// src/api/inventoryAPI.js
...
export const deleteInventoryItem = (id, type) => api.delete(`/inventory/${id}`, { params: { type } });

// Aliases for backward compatibility (if your older components still use these names)
...
export const addItem = (data) => api.post('/inventory/items', data); // add borrowable item
